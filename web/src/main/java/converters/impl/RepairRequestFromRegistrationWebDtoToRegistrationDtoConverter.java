...
@Component
public class RepairRequestFromRegistrationWebDtoToRegistrationDtoConverter implements
    ...
    @Autowired
    public RepairRequestFromRegistrationWebDtoToRegistrationDtoConverter(AppointmentSlotWebDtoToAppointmentSlotDtoConverter appointmentSlotWebDtoToAppointmentSlotDtoConverter) {
